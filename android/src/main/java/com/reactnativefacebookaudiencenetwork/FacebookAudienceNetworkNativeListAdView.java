...
public class FacebookAudienceNetworkNativeListAdView extends LinearLayout {
  ...
  public FacebookAudienceNetworkNativeListAdView(ThemedReactContext themedReactContext) {
    super(themedReactContext);
    context = themedReactContext;
    mEventEmitter = context.getJSModule(RCTEventEmitter.class);
    inflate(context, R.layout.native_ad_small_card, this);
  ...
  private void inflateAd(NativeAd nativeAd) {
    ...
    adView = (LinearLayout) inflater.inflate(R.layout.native_ad_small_layout, nativeAdLayout, false);
   ...
   // nativeAdSocialContext.setText(nativeAd.getAdSocialContext());
    ...
    //nativeAdMedia.setVisibility(View.INVISIBLE);
    context.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)
